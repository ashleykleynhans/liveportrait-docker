...
![Docker Pulls](https://img.shields.io/docker/pulls/ashleykza/liveportrait?style=for-the-badge&logo=docker&label=Docker%20Pulls&link=https%3A%2F%2Fhub.docker.com%2Frepository%2Fdocker%2Fashleykza%2Fliveportrait%2Fgeneral)
...
https://runpod.io/console/deploy?template=bq3dmz6nwp&ref=2xxro4sy)
...
```bash
# Clone the repo
git clone https://github.com/ashleykleynhans/liveportrait-docker.git

# Log in to Docker Hub
docker login

# Build the image, tag the image, and push the image to Docker Hub
cd liveportrait-docker
...
| DISABLE_AUTOLAUNCH   | Disable LivePortrait from launching automatically | (not set)             |
| DISABLE_SYNC         | Disable syncing if using a RunPod network volume  | (not set)             |

## Logs

LivePortrait creates a log file, and you can tail the log instead of
killing the service to view the logs.

| Application  | Log file                         |
|--------------|----------------------------------|
| LivePortrait | /workspace/logs/LivePortrait.log |

For example:

```bash
tail -f /workspace/logs/LivePortrait.log
```

## Community and Contributing

Pull requests and issues on [GitHub](https://github.com/ashleykleynhans/liveportrait-docker)
